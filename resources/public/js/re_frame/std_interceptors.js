...
var vec__20575_20578 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_20579 = cljs.core.nth.call(null,vec__20575_20578,(0),null);
var only_after_20580 = cljs.core.nth.call(null,vec__20575_20578,(1),null);
var db_changed_QMARK__20581 = (!((only_before_20579 == null))) || (!((only_after_20580 == null)));
if(db_changed_QMARK__20581){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_20579);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_20580);
...
var map__20582 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__20582__$1 = ((((!((map__20582 == null)))?((((map__20582.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20582.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20582):map__20582);
var db = cljs.core.get.call(null,map__20582__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__20582__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__20584 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__20584__$1;
var event = cljs.core.get.call(null,map__20584__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__8814__auto___20587 = arguments.length;
var i__8815__auto___20588 = (0);
while(true){
if((i__8815__auto___20588 < len__8814__auto___20587)){
args__8821__auto__.push((arguments[i__8815__auto___20588]));

var G__20589 = (i__8815__auto___20588 + (1));
i__8815__auto___20588 = G__20589;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq20586){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq20586));
});
...
var args__8821__auto__ = [];
var len__8814__auto___20595 = arguments.length;
var i__8815__auto___20596 = (0);
while(true){
if((i__8815__auto___20596 < len__8814__auto___20595)){
args__8821__auto__.push((arguments[i__8815__auto___20596]));

var G__20597 = (i__8815__auto___20596 + (1));
i__8815__auto___20596 = G__20597;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__20590_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__20591_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__20591_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq20592){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__20593,G__20594,seq20592__$2);
});
