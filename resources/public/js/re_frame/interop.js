...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__19852 = cljs.core.instance_QMARK_;
var expr__19853 = reactive_val;
if(cljs.core.truth_(pred__19852.call(null,reagent.ratom.RAtom,expr__19853))){
return "ra";
} else {
if(cljs.core.truth_(pred__19852.call(null,reagent.ratom.RCursor,expr__19853))){
return "rc";
} else {
if(cljs.core.truth_(pred__19852.call(null,reagent.ratom.Reaction,expr__19853))){
return "rx";
} else {
if(cljs.core.truth_(pred__19852.call(null,reagent.ratom.Track,expr__19853))){
return "tr";
} else {
return "other";
}
