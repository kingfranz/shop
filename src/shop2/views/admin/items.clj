(ns shop2.views.admin.items
    (:require [mongolib.core :as db]
              ...
              [shop2.db.tags :refer [get-tag]]
              [shop2.db.items :refer [create-item-obj item-id-exists? get-item get-items update-item add-item delete-item]]
              [shop2.db.lists :refer [list-id-exists? get-lists]]
