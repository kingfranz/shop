...
(cc/defroutes user-routes
	...
	(cc/GET "/:list-type" request
		(set-home-type request (-> request :params :list-type)))
	...
	(cc/GET "/clean-list/:id" request
	    (clean-list request (-> request :params :id)))
...
(cc/defroutes admin-routes
    ...
    (cc/POST "/edited-user" request
             (edit-user! request))

    (cc/GET "/delete-user/:userid" request
